    ...
    return (
        ...
        <div className="footer-cont" >
            <div className="footer-des" >
                ...
                <SocialIcon className="socialicon" network="instagram" url="https://www.instagram.com/iamakkar" fgColor='#fff' />
                <SocialIcon className="socialicon" network="email" url="mailto:makkardeepansh@gmail.com" fgColor='#fff' />
                <SocialIcon className="socialicon" network="facebook" url="mailto:makkardeepansh@gmail.com" fgColor='#fff' />
                </div>
            </div>

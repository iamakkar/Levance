...
var about = "Levance.in is a peculiar influencer-marketing platform that works mostly with nano and micro influencers. It embarks upon providing best marketing campaigns to brands and connect them with their right set of influencers.";
...
export default function App() {
    ...
    columns={[
        {
            title: "About Us:",
            style: {fontFamily: 'Ubuntu', width: 400},
            items: [
                {
                    title: about,

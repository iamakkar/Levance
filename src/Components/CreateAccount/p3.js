        ...
        <div className="col s12 m12">
          ...
          <div className="wrappercreateaccount1" >
            ...
            <div className="con-inputcreateaccount1">
              <input placeholder="Pick username" type="text" onBlur={val => { props.setUsername(val.target.value); }} onChange={val => checkUsername(val)} onKeyPress={(e)=>{if(e.key=="Enter") document.getElementById("password").focus()}} />
              <i className="icon">
                <Person />
              </i>
            ...
            <div className="con-inputcreateaccount1">
              <input placeholder="Password" id="password" type={!visible ? "password" : "text"} onBlur={val => { props.setPassword(val.target.value); passwordCheck(val) }} onKeyPress={(e)=>{if(e.key=="Enter") document.getElementById("cpassword").focus()}} />
              <i className="icon">
                <Lock />
              </i>
            ...
            <div className={checked ? "con-inputcreateaccount1" : 'invalid'}>
              <input placeholder="Confirm Password" id="cpassword" type={!cvisible ? "password" : "text"} onChange={(val) => passwordCheck(val)} onBlur={(val) => passwordCheck(val)} onKeyPress={(e)=>{if(e.key=="Enter") {document.getElementById("submit").click();document.getElementById("cpassword").blur()}}}/>
              <i className="icon">
                <Lock />
              </i>
            ...
            <button id="submit" className="buttn" disabled={check_username} onClick={Next}>Next</button>
            <span>or</span>
